...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7b80458, const void *arg_0xb7b805f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7b318c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb79db840), 
int (*key_eq_fn)(void *arg_0xb79dbc88, void *arg_0xb79dbe00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb78aa9b8, int arg_0xb78aab10);
static double RandomUniform(void );
...
typedef nx_struct panc_table {
  nx_uint8_t flag_connections[10];
  nx_uint8_t topic_subscriptions[10];
  nx_uint8_t count_retry_conack[10];
  nx_uint8_t count_retry_suback[10];
...
typedef nx_struct node_table {
  nx_uint8_t flag_sub;
  nx_uint8_t flag_conn;
  nx_uint8_t count_retry_conn;
  nx_uint8_t count_retry_sub;
} __attribute__((packed)) 
node_table_t;
...
# 33 "/usr/include/i386-linux-gnu/bits/socket.h" 3
...
typedef TMilli RadioRouteC$Timer6$precision_tag;
typedef TMilli RadioRouteC$Timer1$precision_tag;
typedef TMilli RadioRouteC$Timer4$precision_tag;
typedef TMilli RadioRouteC$Timer2$precision_tag;
typedef TMilli RadioRouteC$Timer5$precision_tag;
...
#line 83
static void RadioRouteC$Timer6$fired(void );
...
#line 83
static void RadioRouteC$Timer4$fired(void );
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
uint8_t len);
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void RadioRouteC$Timer2$fired(void );
#line 83
static void RadioRouteC$Timer5$fired(void );
...
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void RadioRouteC$Timer3$startOneShot(uint32_t dt);
#line 73
static void RadioRouteC$Timer6$startOneShot(uint32_t dt);
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
...
uint8_t len);
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void RadioRouteC$Timer4$startOneShot(uint32_t dt);
#line 73
static void RadioRouteC$Timer2$startOneShot(uint32_t dt);
#line 73
static void RadioRouteC$Timer5$startOneShot(uint32_t dt);
# 43 "RadioRouteC.nc"
...
uint16_t RadioRouteC$time_delays[1000][10];
char RadioRouteC$topics[1000][4][15];
panc_table_t RadioRouteC$panc_table[1000];
node_table_t RadioRouteC$node_table[1000][10];
bool RadioRouteC$route_req_sent[1000];
bool RadioRouteC$route_rep_sent[1000];
bool RadioRouteC$locked[1000];
bool RadioRouteC$conn_done[1000];
bool RadioRouteC$sub_done[1000];
...
static inline int RadioRouteC$sendToPort(int nport, char *payload);
...
#line 171
static inline void RadioRouteC$Timer2$fired(void );
#line 185
static inline void RadioRouteC$Timer3$fired(void );
#line 211
static inline void RadioRouteC$Timer4$fired(void );
#line 241
static inline void RadioRouteC$Timer5$fired(void );
#line 268
static inline void RadioRouteC$Timer6$fired(void );
#line 292
static inline bool RadioRouteC$connections_established(void );
#line 304
static inline bool RadioRouteC$subscriptions_established(void );
#line 319
static inline int RadioRouteC$sendToPort(int nport, char *payload);
#line 362
...
static error_t /*RadioRouteAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
#line 319
{
  ...
  if (socket_desc < 0) {
      sim_log_debug(162U, "radio_rec", "Unable to create socket\n");
      return -1;
    }
  sim_log_debug(163U, "radio_rec", "Socket created successfully\n");
  ...
  if (connect(socket_desc, (struct sockaddr *)&server_addr, sizeof server_addr) < 0) {
      sim_log_debug(164U, "radio_rec", "Unable to connect\n");
      return -1;
    }

  sim_log_debug(165U, "radio_rec", "Connected with server successfully\n");



  if (send(socket_desc, payload, strlen(payload), 0) < 0) {
      sim_log_debug(166U, "radio_rec", "Unable to send message\n");
      return -1;
    }
...
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void RadioRouteC$Timer6$startOneShot(uint32_t dt){
#line 73
...
#line 309
  for (i = 2; i < 10; i++) {
      if (__nesc_ntoh_uint8(RadioRouteC$panc_table[sim_node()].topic_subscriptions[i].nxdata) != 0) {
        nsubs++;
        }
    }
#line 313
...
#line 297
  for (i = 2; i < 10; i++) {
      if (__nesc_ntoh_uint8(RadioRouteC$panc_table[sim_node()].flag_connections[i].nxdata) == 0) {
        return FALSE;
        }
    }
#line 301
...
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void RadioRouteC$Timer3$startOneShot(uint32_t dt){
#line 73
...
#line 369
  if (len == sizeof(mqtt_light_msg_t )) {
      ...
      if (__nesc_ntoh_uint8(rsm->type.nxdata) == 0 && !RadioRouteC$conn_done[sim_node()] && !RadioRouteC$sub_done[sim_node()]) {

          __nesc_hton_uint8(rsm->type.nxdata, 1);
          __nesc_hton_uint32(rsm->destination.nxdata, __nesc_ntoh_uint32(rsm->sender.nxdata));
          __nesc_hton_uint32(rsm->sender.nxdata, 1);

          sim_log_debug(167U, "radio_rec", "Replying with CONACK!, DEST %d type %d \n", __nesc_ntoh_uint32(rsm->destination.nxdata), __nesc_ntoh_uint8(rsm->type.nxdata));
          if (RadioRouteC$AMSend$send(__nesc_ntoh_uint32(rsm->destination.nxdata), bufPtr, sizeof(mqtt_light_msg_t )) == SUCCESS) {
              __nesc_hton_uint8(RadioRouteC$panc_table[sim_node()].sender_conack.nxdata, __nesc_ntoh_uint32(rsm->destination.nxdata));
              RadioRouteC$Timer3$startOneShot(RadioRouteC$time_delays[sim_node()][__nesc_ntoh_uint32(rsm->destination.nxdata)]);
            }
        }
      else {


        if (__nesc_ntoh_uint8(rsm->type.nxdata) == 1 && !RadioRouteC$conn_done[sim_node()] && !RadioRouteC$sub_done[sim_node()]) {
            __nesc_hton_uint8(RadioRouteC$node_table[sim_node()][TOS_NODE_ID].flag_conn.nxdata, 1);
            sim_log_debug(168U, "radio_rec", "I received the CONACK\n");

            __nesc_hton_uint8(rsm->type.nxdata, 2);
            __nesc_hton_uint32(rsm->destination.nxdata, __nesc_ntoh_uint32(rsm->sender.nxdata));
            __nesc_hton_uint32(rsm->sender.nxdata, TOS_NODE_ID);
            if (RadioRouteC$AMSend$send(__nesc_ntoh_uint32(rsm->destination.nxdata), bufPtr, sizeof(mqtt_light_msg_t )) == SUCCESS) {
                sim_log_debug(169U, "timer", "CACK sent!\n");
              }
          }
        else {

          if (__nesc_ntoh_uint8(rsm->type.nxdata) == 2 && TOS_NODE_ID == 1 && !RadioRouteC$conn_done[sim_node()] && !RadioRouteC$sub_done[sim_node()]) {
              __nesc_hton_uint8(RadioRouteC$panc_table[sim_node()].flag_connections[__nesc_ntoh_uint32(rsm->sender.nxdata)].nxdata, 1);

              sim_log_debug(170U, "radio_rec", "Connection enstablished with %d\n", __nesc_ntoh_uint32(rsm->sender.nxdata));
              for (i = 2; i < 10; i++) 
                sim_log_debug(171U, "radio_rec", "C: %d\n", __nesc_ntoh_uint8(RadioRouteC$panc_table[sim_node()].flag_connections[i].nxdata));

              if (RadioRouteC$connections_established()) {

                  RadioRouteC$conn_done[sim_node()] = TRUE;
                  __nesc_hton_uint8(rsm->type.nxdata, 3);
                  __nesc_hton_uint32(rsm->sender.nxdata, 1);

                  if (RadioRouteC$AMSend$send(AM_BROADCAST_ADDR, bufPtr, sizeof(mqtt_light_msg_t )) == SUCCESS) {
                      sim_log_debug(172U, "timer", "SSTART sent!\n");
                    }
                }
            }
          else {
            ...
            if (__nesc_ntoh_uint8(rsm->type.nxdata) == 3 && !RadioRouteC$sub_done[sim_node()]) {
                int topic_choice = 2;

#line 427
                __nesc_hton_uint8(rsm->type.nxdata, 4);
                __nesc_hton_uint32(rsm->destination.nxdata, 1);
                __nesc_hton_uint32(rsm->sender.nxdata, TOS_NODE_ID);
                if (TOS_NODE_ID % 2 == 0) {
                    topic_choice = 1;
                  }
                __nesc_hton_uint8(rsm->topic.nxdata, topic_choice);
                if (RadioRouteC$AMSend$send(__nesc_ntoh_uint32(rsm->destination.nxdata), bufPtr, sizeof(mqtt_light_msg_t )) == SUCCESS) {
                    sim_log_debug(173U, "radio_rec", "Sending MQTT SUB!, DEST %d type %d \n", __nesc_ntoh_uint32(rsm->destination.nxdata), __nesc_ntoh_uint8(rsm->type.nxdata));
                    RadioRouteC$Timer4$startOneShot(RadioRouteC$time_delays[sim_node()][__nesc_ntoh_uint32(rsm->destination.nxdata)]);
                  }
              }
            else {


              if (__nesc_ntoh_uint8(rsm->type.nxdata) == 4 && !RadioRouteC$sub_done[sim_node()]) {
                  __nesc_hton_uint8(rsm->type.nxdata, 5);
                  __nesc_hton_uint32(rsm->destination.nxdata, __nesc_ntoh_uint32(rsm->sender.nxdata));
                  __nesc_hton_uint32(rsm->sender.nxdata, 1);

                  sim_log_debug(174U, "radio_rec", "Replying with SUBACK!, DEST %d type %d \n", __nesc_ntoh_uint32(rsm->destination.nxdata), __nesc_ntoh_uint8(rsm->type.nxdata));
                  if (RadioRouteC$AMSend$send(__nesc_ntoh_uint32(rsm->destination.nxdata), bufPtr, sizeof(mqtt_light_msg_t )) == SUCCESS) {
                      __nesc_hton_uint8(RadioRouteC$panc_table[sim_node()].sender_suback.nxdata, __nesc_ntoh_uint32(rsm->destination.nxdata));
                      RadioRouteC$Timer5$startOneShot(RadioRouteC$time_delays[sim_node()][__nesc_ntoh_uint32(rsm->destination.nxdata)]);
                    }
                }
              else {
                if (__nesc_ntoh_uint8(rsm->type.nxdata) == 5 && !RadioRouteC$sub_done[sim_node()]) {
                    __nesc_hton_uint8(RadioRouteC$node_table[sim_node()][TOS_NODE_ID].flag_sub.nxdata, 1);

                    __nesc_hton_uint8(rsm->type.nxdata, 6);
                    __nesc_hton_uint32(rsm->destination.nxdata, 1);
                    __nesc_hton_uint32(rsm->sender.nxdata, TOS_NODE_ID);

                    if (RadioRouteC$AMSend$send(__nesc_ntoh_uint32(rsm->destination.nxdata), bufPtr, sizeof(mqtt_light_msg_t )) == SUCCESS) {
                        sim_log_debug(175U, "radio_rec", "Sending MQTT SACK!, DEST %d type %d \n", __nesc_ntoh_uint32(rsm->destination.nxdata), __nesc_ntoh_uint8(rsm->type.nxdata));
                      }
                  }
                else {


                  if (__nesc_ntoh_uint8(rsm->type.nxdata) == 6 && !RadioRouteC$sub_done[sim_node()]) {
                      __nesc_hton_uint8(RadioRouteC$panc_table[sim_node()].topic_subscriptions[__nesc_ntoh_uint32(rsm->sender.nxdata)].nxdata, __nesc_ntoh_uint8(rsm->topic.nxdata));
                      sim_log_debug(176U, "radio_rec", "SACK received!, DEST %d type %d \n", __nesc_ntoh_uint32(rsm->destination.nxdata), __nesc_ntoh_uint8(rsm->type.nxdata));
                      sim_log_debug(177U, "radio_rec", "Node %d subscribed to %s! \n", __nesc_ntoh_uint32(rsm->sender.nxdata), RadioRouteC$topics[sim_node()][__nesc_ntoh_uint8(rsm->topic.nxdata)]);

                      for (i = 2; i < 10; i++) 
                        sim_log_debug(178U, "radio_rec", "S: %s\n", RadioRouteC$topics[sim_node()][__nesc_ntoh_uint8(RadioRouteC$panc_table[sim_node()].topic_subscriptions[i].nxdata)]);

                      if (RadioRouteC$subscriptions_established()) {
                          RadioRouteC$sub_done[sim_node()] = TRUE;
                          __nesc_hton_uint8(rsm->type.nxdata, 7);
                          __nesc_hton_uint32(rsm->sender.nxdata, 1);

                          if (RadioRouteC$AMSend$send(AM_BROADCAST_ADDR, bufPtr, sizeof(mqtt_light_msg_t )) == SUCCESS) {
                              sim_log_debug(179U, "timer", "PSTART sent!\n");
                            }
                        }
                    }
                  else {

                    if (__nesc_ntoh_uint8(rsm->type.nxdata) == 7) {
                        RadioRouteC$Timer6$startOneShot(RadioRouteC$time_delays[sim_node()][TOS_NODE_ID]);
                      }
                    else {
                      if (__nesc_ntoh_uint8(rsm->type.nxdata) == 8) {
                          if (TOS_NODE_ID == 1) {
                              int i;
                              int topic_choice = 1;
                              char p[30];
                              ...
                              sim_log_debug(180U, "timer", "MQTT PUB received!\n");
                              sprintf(p, "%s %d", RadioRouteC$topics[sim_node()][__nesc_ntoh_uint8(rsm->topic.nxdata)], __nesc_ntoh_uint8(rsm->payload.nxdata));
                              sim_log_debug(181U, "radio_rec", "Result send: %d\n", RadioRouteC$sendToPort(60001, p));
                              for (i = 2; i < 10; i++) {
                                  if (__nesc_ntoh_uint8(RadioRouteC$panc_table[sim_node()].topic_subscriptions[i].nxdata) == __nesc_ntoh_uint8(rsm->topic.nxdata)) {
                                      __nesc_hton_uint8(rsm->type.nxdata, 8);
                                      __nesc_hton_uint32(rsm->destination.nxdata, i);
                                      __nesc_hton_uint32(rsm->sender.nxdata, 1);
                                      RadioRouteC$generate_send(__nesc_ntoh_uint32(rsm->destination.nxdata), bufPtr, sizeof(mqtt_light_msg_t ));
                                      sim_log_debug(182U, "radio_rec", "Forwarding MQTT PUB to %d type %d payload %d! \n", __nesc_ntoh_uint32(rsm->destination.nxdata), __nesc_ntoh_uint8(rsm->type.nxdata), __nesc_ntoh_uint8(rsm->payload.nxdata));
                                    }
                                }
                            }
                        }
...
#line 162
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb72b52b0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb72b52b0, addr, msg, len);
#line 80
...
#line 75
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb76588b0, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb76588b0, msg, error);
#line 110
}
#line 110
...
#line 517
{
  ...
  if (&RadioRouteC$packet[sim_node()] == bufPtr) {
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb72b68a8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb72b68a8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb72b68a8, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb7806650){
#line 75
  switch (arg_0xb7806650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb7806650);
#line 75
      break;
#line 75
    }
...
#line 115
      rsm = (mqtt_light_msg_t *)RadioRouteC$Packet$getPayload(&packet, sizeof(mqtt_light_msg_t ));
      if (rsm == (void *)0) {
          return;
        }


      if (RadioRouteC$AMSend$send(address, packet, sizeof(mqtt_light_msg_t )) == SUCCESS) {
          sim_log_debug(148U, "timer", "Actual packet sent!\n");
...
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void RadioRouteC$Timer2$startOneShot(uint32_t dt){
#line 73
...
#line 150
{
  ...
  rsm = (mqtt_light_msg_t *)RadioRouteC$Packet$getPayload(&RadioRouteC$packet[sim_node()], sizeof(mqtt_light_msg_t ));

  if (TOS_NODE_ID != 1) {

      __nesc_hton_uint8(rsm->type.nxdata, 0);
      __nesc_hton_uint32(rsm->destination.nxdata, 1);
      __nesc_hton_uint32(rsm->sender.nxdata, TOS_NODE_ID);

      if (RadioRouteC$AMSend$send(__nesc_ntoh_uint32(rsm->destination.nxdata), &RadioRouteC$packet[sim_node()], sizeof(mqtt_light_msg_t )) == SUCCESS) {
          RadioRouteC$Timer2$startOneShot(RadioRouteC$time_delays[sim_node()][TOS_NODE_ID]);
          sim_log_debug(150U, "timer", "MQTT CONN: packet sent!\n");
        }
    }
}
...
#line 171
{
  ...
  if (TOS_NODE_ID != 1 && __nesc_ntoh_uint8(RadioRouteC$node_table[sim_node()][TOS_NODE_ID].flag_conn.nxdata) == 0 && __nesc_ntoh_uint8(RadioRouteC$node_table[sim_node()][TOS_NODE_ID].count_retry_conn.nxdata) < 3) {

      sim_log_debug(151U, "timer", "MQTT CONN: packet sent again!\n");
      (__nesc_temp42 = RadioRouteC$node_table[sim_node()][TOS_NODE_ID].count_retry_conn.nxdata, __nesc_hton_uint8(__nesc_temp42, (__nesc_temp43 = __nesc_ntoh_uint8(__nesc_temp42)) + 1), __nesc_temp43);
      sim_log_debug(152U, "timer", "Updating CONN retry count: %d\n", __nesc_ntoh_uint8(RadioRouteC$node_table[sim_node()][TOS_NODE_ID].count_retry_conn.nxdata));
      RadioRouteC$Timer1$startOneShot(500);
    }
}
...
#line 185
{
  ...
  if (TOS_NODE_ID == 1) {
      int sender = __nesc_ntoh_uint8(RadioRouteC$panc_table[sim_node()].sender_conack.nxdata);

#line 193
      if (__nesc_ntoh_uint8(RadioRouteC$panc_table[sim_node()].flag_connections[sender].nxdata) == 0 && __nesc_ntoh_uint8(RadioRouteC$panc_table[sim_node()].count_retry_conack[sender].nxdata) < 3) {

          sim_log_debug(153U, "timer", "MQTT CONNACK: ack lost!\n");
          (__nesc_temp44 = RadioRouteC$panc_table[sim_node()].count_retry_conack[sender].nxdata, __nesc_hton_uint8(__nesc_temp44, (__nesc_temp45 = __nesc_ntoh_uint8(__nesc_temp44)) + 1), __nesc_temp45);
          sim_log_debug(154U, "timer", "Updating CONNACK retry count: %d!\n", __nesc_ntoh_uint8(RadioRouteC$panc_table[sim_node()].count_retry_conack[sender].nxdata));
          rsm = (mqtt_light_msg_t *)RadioRouteC$Packet$getPayload(&RadioRouteC$packet[sim_node()], sizeof(mqtt_light_msg_t ));
          __nesc_hton_uint8(rsm->type.nxdata, 1);
          __nesc_hton_uint32(rsm->destination.nxdata, sender);
          __nesc_hton_uint32(rsm->sender.nxdata, 1);
          if (RadioRouteC$AMSend$send(sender, &RadioRouteC$packet[sim_node()], sizeof(mqtt_light_msg_t )) == SUCCESS) {

              sim_log_debug(155U, "timer", "MQTT CONNACK: packet sent again!\n");
              RadioRouteC$Timer3$startOneShot(RadioRouteC$time_delays[sim_node()][sender]);
            }
        }
    }
}
...
#line 211
{
  ...
  if (TOS_NODE_ID != 1 && __nesc_ntoh_uint8(RadioRouteC$node_table[sim_node()][TOS_NODE_ID].flag_sub.nxdata) == 0 && __nesc_ntoh_uint8(RadioRouteC$node_table[sim_node()][TOS_NODE_ID].count_retry_sub.nxdata) < 3 && !RadioRouteC$sub_done[sim_node()]) {
      (__nesc_temp46 = RadioRouteC$node_table[sim_node()][TOS_NODE_ID].count_retry_sub.nxdata, __nesc_hton_uint8(__nesc_temp46, (__nesc_temp47 = __nesc_ntoh_uint8(__nesc_temp46)) + 1), __nesc_temp47);
      ...
      if (RadioRouteC$AMSend$send(1, &RadioRouteC$packet[sim_node()], sizeof(mqtt_light_msg_t )) == SUCCESS) {

          sim_log_debug(156U, "timer", "MQTT SUB: packet sent again!\n");
          RadioRouteC$Timer4$startOneShot(RadioRouteC$time_delays[sim_node()][TOS_NODE_ID]);
        }
    }
}
...
#line 241
{
  ...
  if (TOS_NODE_ID == 1) {
      int sender = __nesc_ntoh_uint8(RadioRouteC$panc_table[sim_node()].sender_suback.nxdata);

#line 249
      if (__nesc_ntoh_uint8(RadioRouteC$panc_table[sim_node()].topic_subscriptions[sender].nxdata) == 0 && __nesc_ntoh_uint8(RadioRouteC$panc_table[sim_node()].count_retry_suback[sender].nxdata) < 3) {

          sim_log_debug(157U, "timer", "MQTT SUBACK: ack lost!\n");
          (__nesc_temp48 = RadioRouteC$panc_table[sim_node()].count_retry_suback[sender].nxdata, __nesc_hton_uint8(__nesc_temp48, (__nesc_temp49 = __nesc_ntoh_uint8(__nesc_temp48)) + 1), __nesc_temp49);
          sim_log_debug(158U, "timer", "Updating SUBACK retry count: %d!\n", __nesc_ntoh_uint8(RadioRouteC$panc_table[sim_node()].count_retry_suback[sender].nxdata));
          ...
          if (RadioRouteC$AMSend$send(sender, &RadioRouteC$packet[sim_node()], sizeof(mqtt_light_msg_t )) == SUCCESS) {
              ...
              sim_log_debug(159U, "timer", "MQTT SUBACK: packet sent again!\n");
              RadioRouteC$Timer5$startOneShot(RadioRouteC$time_delays[sim_node()][sender]);
            }
        }
    }
}
...
#line 274
  sim_log_debug(160U, "timer", "PSTART received!\n");
  ...
  __nesc_hton_uint8(rsm->topic.nxdata, topic_choice);
  __nesc_hton_uint8(rsm->payload.nxdata, rand() % 100);
  if (RadioRouteC$AMSend$send(__nesc_ntoh_uint32(rsm->destination.nxdata), &RadioRouteC$packet[sim_node()], sizeof(mqtt_light_msg_t )) == SUCCESS) {
      sim_log_debug(161U, "radio_rec", "Sending MQTT PUB!, payload %d DEST %d type %d \n", __nesc_ntoh_uint8(rsm->payload.nxdata), __nesc_ntoh_uint32(rsm->destination.nxdata), __nesc_ntoh_uint8(rsm->type.nxdata));
    }
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb73223a8){
#line 83
  switch (arg_0xb73223a8) {
#line 83
    case 0U:
#line 83
...
#line 83
    case 4U:
#line 83
      RadioRouteC$Timer4$fired();
#line 83
      break;
#line 83
    case 5U:
#line 83
      RadioRouteC$Timer5$fired();
#line 83
      break;
#line 83
    case 6U:
#line 83
      RadioRouteC$Timer6$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb73223a8);
#line 83
      break;
#line 83
    }
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "RadioRouteC$topics"))
  {
    *addr = (uintptr_t)&RadioRouteC$topics[__nesc_mote];
    *size = sizeof(RadioRouteC$topics[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$panc_table"))
  {
    *addr = (uintptr_t)&RadioRouteC$panc_table[__nesc_mote];
    *size = sizeof(RadioRouteC$panc_table[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$node_table"))
  {
    *addr = (uintptr_t)&RadioRouteC$node_table[__nesc_mote];
    *size = sizeof(RadioRouteC$node_table[__nesc_mote]);
    return 0;
  }
  ...
  if (!strcmp(varname, "RadioRouteC$conn_done"))
  {
    *addr = (uintptr_t)&RadioRouteC$conn_done[__nesc_mote];
    *size = sizeof(RadioRouteC$conn_done[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$sub_done"))
  {
    *addr = (uintptr_t)&RadioRouteC$sub_done[__nesc_mote];
    *size = sizeof(RadioRouteC$sub_done[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  memcpy((void *)&RadioRouteC$time_delays[__nesc_mote], (void *)&(unsigned short [10]){ 0, 61, 173, 267, 371, 479, 583, 689, 792, 897 }, sizeof RadioRouteC$time_delays[__nesc_mote]);
  memcpy((void *)&RadioRouteC$topics[__nesc_mote], (void *)&(char [4][15]){ "NOT SUBSCRIBED", "TEMPERATURE", "HUMIDITY", "LUMINOSITY" }, sizeof RadioRouteC$topics[__nesc_mote]);
  memset((void *)&RadioRouteC$panc_table[__nesc_mote], 0, sizeof RadioRouteC$panc_table[__nesc_mote]);
  memset((void *)&RadioRouteC$node_table[__nesc_mote], 0, sizeof RadioRouteC$node_table[__nesc_mote]);
  RadioRouteC$route_req_sent[__nesc_mote] = FALSE;
  RadioRouteC$route_rep_sent[__nesc_mote] = FALSE;
  RadioRouteC$locked[__nesc_mote] = FALSE;
  RadioRouteC$conn_done[__nesc_mote] = FALSE;
  RadioRouteC$sub_done[__nesc_mote] = FALSE;
